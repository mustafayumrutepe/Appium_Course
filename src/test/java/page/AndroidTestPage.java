...
public class AndroidTestPage {
    public AndroidTestPage(){PageFactory.initElements(Driver.getAndroidDriver(),this);}
    ...
    //********************************************* Methods ****************************************************************
    public void usernameTextBoxSednKey(String key){
        usernameTextBox.sendKeys(key);
    }
    public void passwordTextBoxSednKey(String key){
